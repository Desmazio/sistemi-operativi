...
import it.nuoro.progetto.model.ProdottiFactory;
 ...
 * @author paual
 */
@WebServlet(name = "MarketplaceServlet", urlPatterns = {"/MarketplaceServlet"})
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            if(prodotti != null){
                ...
                String redirectUrl = session.getAttribute("getProdottiReturnUrl").toString();
